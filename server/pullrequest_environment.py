...
class PullRequestEnvironment(Environment):
    ...
    def reset(self, task_id=None):
        ...
        return PRObservation(
            ...
            test_results=self.current_task.get("test_results", None),
            repo_tree=self.current_task.get("repo_tree", None),
            previous_comments=self.current_task.get("previous_comments", None),
            review_status=self.current_task.get("review_status", "pending"),
